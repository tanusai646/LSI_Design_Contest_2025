start_gui
create_project sdcard_sys ./ -part xc7z020clg400-1
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files ./sdcard_sys.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse ./sdcard_sys.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
launch_runs impl_1 -to_step write_bitstream -jobs 6


#file mkdir ./sdcard_sys.sdk
#file copy -force ./sdcard_sys.runs/impl_1/design_1_wrapper.sysdef ./sdcard_sys.sdk/design_1_wrapper.hdf


#launch_sdk -workspace ./sdcard_sys.sdk -hwspec ./sdcard_sys.sdk/design_1_wrapper.hdf
